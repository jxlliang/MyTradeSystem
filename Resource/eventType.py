...
EVENT_INSTRUMENT='eInstrument'          # 查询合约
EVENT_INVESTOR='eInvestor'              # 查询投资者
EVENT_CONTRACT = 'eContract.'           # 合约基础信息回报事件
EVENT_ERROR = 'eError.'                 # 错误回报事件
EVENT_MARKETDATA='eMarketdata'     # stock、future的行情数据
EVENT_INDEX_MARKETDATA='eIndexMarketdata' # 指数的行情数据
EVENT_STOCK_EM_MARKETDATA='eStockEMMarketdata' # 东方财富股票的行情数据
EVENT_TDLOGIN='eEvent_TdLogin'            # 登陆的标志
EVENT_INSTRUMENTMARGINRATE='eInstrumentMarginRate' # 合约保证金率
# CTA模块相关
